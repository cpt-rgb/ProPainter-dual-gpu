...
class TrackingAnything():
    def __init__(self, sam_checkpoint, cutie_checkpoint, propainter_checkpoint, raft_checkpoint, flow_completion_checkpoint, args):
        ...
        inpainter_device = 'cuda:1' if torch.cuda.device_count() > 1 else args.device
        self.baseinpainter = ProInpainter(propainter_checkpoint, raft_checkpoint, flow_completion_checkpoint, device=inpainter_device, use_half=True)
